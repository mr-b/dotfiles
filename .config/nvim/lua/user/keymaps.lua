...
keymap("n", "<leader>bf", "<cmd>lua require('telescope.builtin').git_branches()<cr>", opts)
keymap("n", "<leader>ec", "<cmd>lua require('telescope.builtin').find_files({cwd='~/.config'})<cr>", opts)
keymap("n", "<leader>en", "<cmd>lua require('telescope.builtin').find_files({search_dirs={'~/.config/nvim'}})<cr>", opts)
